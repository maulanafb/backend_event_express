...
const createCategories = async (req) => {
  ...
  const result = await Categories.create({ organizer: req.user.organizer });
...
const deleteCategories = async (req) => {
  ...
  const deletedCategory = await Categories.findOneAndDelete({ _id: id, organizer: req.user.organizer });
